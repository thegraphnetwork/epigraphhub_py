...
def get_data_by_location(
    ...
    """
    This function provides a DataFrame for the table selected in the param table_name and the chosen regions in the param georegion.
    ...
    loc : Union[list[str], str]
        This list contains all the locations of interest or the string 'All' to return all the regions.
    ...
    if type(loc) != list and loc != "All":
        raise Exception(
            """Error. The georegion param should be a list or the string 'All' to return all the georegions."""
        )
