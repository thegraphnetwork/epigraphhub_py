...
def test_fetching_tables_for_daily_data():
    dataset_tables = [t for t, url in extract.fetch(freq="daily")]
    expected_tables = [
        "cases",
        "casesVaccPersons",
        "hosp",
...
def test_fetching_tables_for_weekly_data_default():
    dataset_tables = [t for t, url in extract.fetch(freq="weekly")]
    expected_tables = [
        "cases",
        "hosp",
        "death",
...
def test_fetching_tables_for_weekly_data_by_age():
    dataset_tables = [t for t, url in extract.fetch(freq="weekly", by="age")]
    expected_tables = [
        "cases",
        "casesVaccPersons",
        "hosp",
...
def test_fetching_tables_for_weekly_data_by_sex():
    dataset_tables = [t for t, url in extract.fetch(freq="weekly", by="sex")]
    expected_tables = [
        "cases",
        "casesVaccPersons",
        "hosp",
